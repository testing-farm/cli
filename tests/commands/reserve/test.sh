...
testing-farm reserve $ssh_key_option --dry-run --fedora-koji-build 123::install=false --fedora-copr-build some-project:fedora-38::install=false --redhat-brew-build 456::install=false --repository baseurl::install=false --repository-file https://example.com.repo::install=false | tee output
